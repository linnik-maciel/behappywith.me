...
class ImageScroller extends React.Component{
    ...
    renderizarImagens(){
        ...
        const estilo = {
            ...
            padding: "0",
            position: "relative",
            widht: `${this.props.elementos.length * 140}px`,
            left: `${this.state.manipularEvento.left}px`
        };
        const lista = this.props.elementos.map((entry, index) => this.renderizarImagem(entry, index));
    ...
    renderizarLabel(){
        ...
        return (
            <div style={estilo}>{this.obterSelecionado().toString()}</div>
        );
    }
